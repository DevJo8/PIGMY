...
function copyCa() {
	const ca = "J4tKfGfD6obuNwocH3MskyF2LyLwdB9r7658qSe1pump";
...
document.getElementById("download-pfp").addEventListener("click", async () => {
	try {
		...
		link.download = "PIGMY_PFP.png"; // Ubah nama file menjadi EXO_PFP agar sesuai tema
...
function changeChoice(e) {
	const arrow = e.target.closest(".generator-choice-arrow");
	if (!arrow) return;
